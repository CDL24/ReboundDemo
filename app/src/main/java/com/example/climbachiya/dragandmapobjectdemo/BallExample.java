...
public class BallExample extends FrameLayout implements SpringListener, SpringSystemListener {
  ...
  private View ballView1, ballView2, ballView3, ballView4,ballView5,ballView6, ballView7, ballView8;
  ...
  private void init() {
    inflate(getContext(), R.layout.ball_layout, this);

    this.ballView1 = findViewById(R.id.view1);
    this.ballView2 = findViewById(R.id.view2);
    this.ballView3 = findViewById(R.id.view3);
    this.ballView4 = findViewById(R.id.view4);
    this.ballView5 = findViewById(R.id.view5);
    this.ballView6 = findViewById(R.id.view6);
    this.ballView7 = findViewById(R.id.view7);
    this.ballView8 = findViewById(R.id.view8);

    //ballView1.setOnTouchListener(this);
  }
